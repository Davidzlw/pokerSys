...
class PotManager:
    def __init__(self, game, init_money):
        self.game = game
        self.possession = {player.id: init_money for player in self.game.players}
        self.blind = 1
        self.pot = 0
    ...
    def every_game_init(self):
        ...
        sb_id = (self.game.button_id + 1) % self.game.nplayer
        bb_id = (self.game.button_id + 2) % self.game.nplayer
    ...
    def round(self):
        ...
        begin = (self.game.button_id + 1) % self.game.nplayer
